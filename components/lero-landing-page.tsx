...
import { ArrowRight, BarChart2, Lock, Zap, Mountain } from "lucide-react"
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <h3 className="text-xl font-bold">Restaking Aggregator</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  Dynamically moves assets across chains using NFFL for the best investment strategy.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Lero&quot;s Vision</h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Lero is the go-to platform for decentralized finance investors, offering a comprehensive
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
